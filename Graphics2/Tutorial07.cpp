//--------------------------------------------------------------------------------------
// File: Tutorial07.cpp - DOCUMENTO CON BAJO PESO!
// Version: v 10.0
...
void Draw(static float t)
{
	...
	for (int i = 0; i < g_manager.m_mesh4.size(); i++)
	{
		g_manager.m_mesh4[i].createMeshMatrix(sin(t), sin(t), 0, 0, 0.1f, 0.1f, 0.1f);
...
void Draw()
{
	...
	{
		Manager.Mesh[i].createMeshMatrix(Manager.m_timer, 0, 0, 0, 0.01f, 0.01f, 0.01f);
