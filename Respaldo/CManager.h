...
public:
	...
	void MeshGenerator2();
	void LoadMesh2(int numVertices, int numIndices, aiVector3D* VertexArray, aiVector3D* textCoord, std::vector<std::uint32_t>& IndexArray);
	void readTextMesh2(int i);
	// Mesh 3
	std::vector<CMesh> m_mesh3;
	vector <const char*> filePaths3;
	void MeshGenerator3();
	void LoadMesh3(int numVertices, int numIndices, aiVector3D* VertexArray, aiVector3D* textCoord, std::vector<std::uint32_t>& IndexArray);
	void readTextMesh3(int i);
	// Mesh 4
	std::vector<CMesh> m_mesh4;
	vector <const char*> filePaths4;
	void MeshGenerator4();
	void LoadMesh4(int numVertices, int numIndices, aiVector3D* VertexArray, aiVector3D* textCoord, std::vector<std::uint32_t>& IndexArray);
