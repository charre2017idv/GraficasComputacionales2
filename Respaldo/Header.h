...
//--------------------------------------------------------------------------------------
// File: Header.h
// Version: v 12.0 Respaldo con Blinn EN GL DX
...
struct TextAndMesh
{
	...
	// Square
	const char* ninjaMesh = "Dwarf/Plane/ninjaHead.obj";
	//LPCWSTR ninjaTex = L"ninjaNormals.jpg";
	LPCWSTR ninjaTex = L"ninja_head_AO.dds";

	// Escena
	const char* SceneMesh = "Dwarf/Plane/Scene.fbx";
	LPCWSTR SceneTex = L"textures/Toad_a.jpg";
